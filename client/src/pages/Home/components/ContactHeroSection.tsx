...
const ContactHeroSection = () => {
  return (
    <div className="text-white py-14 bg-primary-950 md:flex md:justify-center">
      <div className="flex flex-col md:px-6 md:flex-row md:items-start items-center gap-8  w-full max-w-[1048px]">
