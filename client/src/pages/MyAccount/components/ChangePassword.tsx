...
import { useChangeUserPassword } from "@/service/mutation";
...
const ChangePassword = () => {
  ...
  const handleChangeUserPassword: SubmitHandler<TChangePassword> = async (
    data
  ) => {
    try {
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="db_outline" size="sm" className="bg-white">
          Change password
        </Button>
      </DialogTrigger>
      <DialogContent>
        ...
        <div>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleChangeUserPassword)}>
